...
{{-- --------------------------------------------------------------------------------------------------------------------- --}}
    ...
    {{-- <link rel="stylesheet" href="{{ url(elixir('style.css')) }}"> --}}
    {{-- <link href="{{ asset('style.css') }}" rel="stylesheet" type="text/css"> --}}
    {{-- <link href="{{ URL::asset('style.css') }}" rel="stylesheet"> --}}
    {{-- <link href="{{ URL::asset('js/active.js') }}" rel="script"> --}}
{{-- --------------------------------------------------------------------------------------------------------------------- --}}
...
<h2>Less#25new. Аутентификация и Авторизация</h2>
